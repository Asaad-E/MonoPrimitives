...
namespace MonoPrimitives
{
    ...
    public static class FontGlyphs5x7
    {
        ...
        private static readonly Dictionary<char, byte[]> Glyphs = new()
        {
            ...
            // ---- lowercase (0x61-0x7A) ----
            ['a'] = new byte[] { 0b00000, 0b01110, 0b00001, 0b01111, 0b10001, 0b10001, 0b01111 },
            ...
            ['e'] = new byte[] { 0b00000, 0b01110, 0b10001, 0b11111, 0b10000, 0b10000, 0b01111 },
            ...
            ['u'] = new byte[] { 0b00000, 0b10001, 0b10001, 0b10001, 0b10001, 0b10011, 0b01101 },
            ...
            ['á'] = new byte[] { 0b00010, 0b01110, 0b00001, 0b01111, 0b10001, 0b10001, 0b01111 },
            ['é'] = new byte[] { 0b00010, 0b01110, 0b10001, 0b11111, 0b10000, 0b10000, 0b01111 },
