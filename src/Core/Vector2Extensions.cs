...
namespace MonoPrimitives
{
    ...
    public static class GameTimeExtensions
    {
        ...
        /// <summary>Shorthand for <c>(float)gameTime.TotalGameTime.TotalSeconds</c> — total elapsed time since the game started, the same shorthand <see cref="GetElapsedTimeSeconds"/> gives the per-frame delta.</summary>
