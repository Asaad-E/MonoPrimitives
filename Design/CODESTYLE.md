...
- Never name "raylib" or other design inspirations anywhere a library user would read (doc comments, guides). Internal implementation comments may reference an algorithm's origin if useful.
